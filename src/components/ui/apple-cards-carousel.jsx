  ...
  return (
    <>
      <motion.div
        ...
        className="relative z-10 flex min-h-[35rem] w-80 flex-col items-start justify-start overflow-hidden rounded-3xl bg-gray-100 md:h-[40rem] md:w-96 dark:bg-neutral-900"
      >
        {/* Overlay */}
        ...
        {isOpen && (
          <>
            ...
            <motion.img
              ...
              className="fixed z-[101] inset-0 m-auto max-w-full max-h-full object-contain cursor-zoom-out"
              onClick={() => setIsOpen(false)}
            />
          </>
        )}
